            ...
            <div class="col-sm-6 col-md-8">
                ...
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item"><a href="{{ route('rank.show', $criteriaAnalysis->id) }}">Normalisasi
                            Tabel</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('rank.final', $criteriaAnalysis->id) }}">Wood Rank</a>
                    </li>
        ...
        <div class="card mb-4">
            <div class="card-body table-responsive">
                ...
                <div class="d-sm-flex align-items-center">
                    <div class="mb-4">
                        <h4 class="mb-0 text-gray-800">Normalisasi Alternatif Kayu</h4>
                    </div>
                </div>
                    ...
                    <tbody>
                        <tr>
                                ...
                                @foreach ($dividers as $index => $divider)
                                    <td scope="col">{{ $divider['kategori'] }} (C{{ $index + 1 }})</td>
                                @endforeach
                            ...
                            @foreach ($normalizations as $normalisasi)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        {{ $normalisasi['wood_name'] }}
                                    </td>
                                    <td class="text-center">
                                        {{ $normalisasi['category_name'] }}
                                    </td>
        ...
        <div class="card">
            <div class="card-body">
                <table id="datatablesSimple" class="table table-bordered table-responsive">
                    <div class="mb-4">
                        <h4 class="mb-0 text-gray-800">Rangking Kayu</h4>
                    </div>
